	...
	var twitterKeys = require('./keys.js');
		...
		var Twitter = require('twitter');
			...
			client.get('favorites/list', params, function(error, tweets, response){
			  ...
			  // console.log(tweets.text);  // The favorites. 
			...
			client.get('statuses/user_timeline', params, function(error, tweets, response){
			  if (!error) {
			    ...
			    console.log(queryUrl)
			    // console.log(JSON.parse(response.body)["text"]);
			    // console.log("Title: " + JSON.parse(response)["user"])
			    // console.log("Title: " + JSON.parse(tweets)["user"])
			    // console.log("Title: " + JSON.stringify(tweets)["text"])
			    console.log("Title: " + JSON.stringify(response.body)["text"])
			    // console.log(tweets.user.screen_name);
			    // console.log(response.user.screen_name);
			    // console.log(tweets.user.name);
			    // console.log(response.user);
			    // console.log(tweets.text);
			    // console.log(tweets["screen_name"]);

			    fs.writeFile("twitter.txt", response.body , function(err) {
			...
			// Twitter.stream('statuses/filter', {screen_name: 'RamblinRoyce'}, function(stream) {
